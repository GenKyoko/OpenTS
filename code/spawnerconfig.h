...
public:
	...
	TStringID<260> ScenarioName{ "spawnmap.ini" };
	TStringID<0xff> MapHash{ "" };
	TStringID<44> MapName{ "" };
	 ...
	 */
	int TunnelId = 0;
	TStringID<0x20> TunnelIp{ "0.0.0.0" };
	int TunnelPort = 0;
	int ListenPort = 1234;
